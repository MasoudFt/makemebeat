...
//       title: "محمد سیحونی",
//       description: "تهیه کننده,نویسنده,کارگردان,تدوین گر",
//       rate: "3.5",
//       price: "150000",
//     },
//     {
...
//           <div className={`mt-5 p-3 items-center grid grid-cols-1 md:grid-cols-3 gap-4`}>
//             {product.slice(currentSlide, currentSlide + 3).map((a) => (
//               <motion.div
//                 key={a.title}
//                 className={`max-w-xs w-full bg-zinc-900 border border-gray-600 rounded-lg shadow-sm overflow-hidden`}
//                 initial={{ opacity: 0 }}
...
//                   <div className="justify-items-end py-4 border-b-2 border-black">
...
//                     <div className="grid items-center space-x-1 rtl:space-x-reverse">
...
//                         />
//                       </Box>
//                       <div className="flex  bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 rounded-sm justify-center dark:bg-blue-200 dark:text-blue-800 ms-2">
