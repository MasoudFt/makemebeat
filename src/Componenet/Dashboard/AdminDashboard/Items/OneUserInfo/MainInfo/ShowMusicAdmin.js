  ...
  return (
    <>
              <div className="grid-rows-2 rounded-lg font-bold text-white text-xl p-2">
                <div className="grid grid-cols-9 border border-zinc-900 py-2 border-b-neutral-800 h-fit gap-2 text-center p-1 text-xs text-slate-300 ">
                  {colItems.map((a) => (
                ...
                {musiclist.length ? (
                  musiclist.map((item) => (
                    ...
                    className="grid grid-cols-9 border border-zinc-900 py-2 border-b-neutral-800 hover:ml-2 items-center gap-2 text-center p-1 text-xs text-cyan-50">
                      ...
                      <img src={imageUrl + item.file_pathImage} alt={item.title} className="h-12 w-12 rounded-full" />
