...
const Classic = ({ Component }) => {
  ...
  const selectGener = ["سمفونی", "کنسرتو", "اپرا", "موسیقی مجلسی", "سولیست بزرگ", "دیگر ..."];

  const [inputValues, setInputValues] = useState({
    user_id: tokenUserId,
    productName: "", productImage: null, createat: Time,
    type: ComponentType?.[0] || 'classic',
    gener: selectGener[0],
  ...
  const productCategoryGroups = [
    { name: "سمفونی", fields: [
        { name: "اجرای کامل mp3.", field: "mainMP3File", labelInput: "اجرای کامل MP3", type: "file", accept: ".mp3", note: "مجاز: mp3 (حداکثر 1000 MB)" },
        { name: "نت و پارتیتور (PDF)", field: "coverImage", labelInput: "فایل نت (PDF)", type: "file", accept: ".pdf", note: "مجاز: pdf (حداکثر 2 MB)" },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
    },
    { name: "کنسرتو", fields: [
        { name: "ejraye sade mp3.", field: "mainMP3File", labelInput: "اجرای صوتی MP3", type: "file", accept: ".mp3", note: "مجاز: mp3 (حداکثر 1000 MB)" },
        { name: "نت و پارتیتور (PDF)", field: "coverImage", labelInput: "فایل نت (PDF)", type: "file", accept: ".pdf", note: "مجاز: pdf (حداکثر 2 MB)" },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
    },
     ...
     { name: "موسیقی مجلسی", fields: [
        { name: "اجرای کامل mp3.", field: "mainMP3File", labelInput: "اجرای کامل MP3", type: "file", accept: ".mp3", note: "مجاز: mp3 (حداکثر 1000 MB)" },
        { name: "نت مجلسی (PDF)", field: "coverImage", labelInput: "فایل نت مجلسی (PDF)", type: "file", accept: ".pdf", note: "مجاز: pdf (حداکثر 2 MB)" },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
    },
     { name: "سولیست بزرگ", fields: [
        { name: "ejraye sade mp3.", field: "mainMP3File", labelInput: "اجرای صوتی MP3", type: "file", accept: ".mp3", note: "مجاز: mp3 (حداکثر 1000 MB)" },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
    },
    { name: "دیگر ...", fields: [
        { name: "فیلد مخصوص دیگر", field: "otherStyle", labelInput: "سبک دیگر", type: "text", note: "" },
        { name: "اجرای کامل mp3.", field: "mainMP3File", labelInput: "اجرای کامل MP3", type: "file", accept: ".mp3", note: "مجاز: mp3 (حداکثر 1000 MB)" },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
    },
  ...
  const inputItems = [
    { label: "عنوان اثر هنری", field: "productName", type: "text", placeholder: "کلاسیک" },
    { label: "تصویر اثر یا کاور", field: "productImage", type: "file", accept: "image/*", placeholder: "انتخاب تصویر" },
    { label: "توضیحات اثر هنری", field: "productDescription", type: "textarea", placeholder: "جزئیات اثر را اینجا وارد کنید..." },
    { label: "آهنگساز/دوره", field: "gammuisc", type: "text", placeholder: "مثال: بتهوون / دوره رمانتیک" },
    { label: "تنظیم کننده (اختیاری)", field: "tempo", type: "text", placeholder: "نام تنظیم کننده" },
  ];
  ...
  const resetForm = () => {
    setInputValues({
      ...
      type: ComponentType?.[0] || 'classic', gener: selectGener[selectedCategoryIndex] || selectGener[0],
      gammuisc: "", tempo: "", productDescription: "",
      demoMP3File: null, mainMP3File: null, tagMP3File: null, waveFile: null, projectFile: null, coverImage: null,
      primaryAmount: "", discountAmount: "", otherStyle: "",
    });
  ...
  return (
    <div dir="rtl" className={baseWrapperClass}>
      <div className={formContainerClass}>
        <h1 className={titleClass}>ثبت محصول {selectGener[selectedCategoryIndex] || "Classic"}</h1>
