...
const Electronic = ({ Component }) => {
  ...
  const selectGener = ["تکنو", "هاوس", "دیپ هاوس", "ترنس", "سینث ویو", "دیگر ..."];

  const [inputValues, setInputValues] = useState({
    user_id: tokenUserId,
    productName: "", productImage: null, createat: Time,
    type: ComponentType?.[0] || 'electronic',
    gener: selectGener[0],
  ...
  const inputItems = [
    { label: "عنوان محصول", field: "productName", type: "text", placeholder: "تکنو" },
    ...
    { label: "گام موسیقی", field: "gammuisc", type: "text", placeholder: "مثال: Gm" },
    { label: "تمپو (BPM)", field: "tempo", type: "text", placeholder: "مثال: 125" },
  ];
  ...
  const resetForm = () => {
    setInputValues({
      ...
      type: ComponentType?.[0] || 'electronic', gener: selectGener[selectedCategoryIndex] || selectGener[0],
      gammuisc: "", tempo: "", productDescription: "",
      demoMP3File: null, mainMP3File: null, tagMP3File: null, waveFile: null, projectFile: null, coverImage: null,
      primaryAmount: "", discountAmount: "", otherStyle: "",
    });
  ...
  return (
    <div dir="rtl" className={baseWrapperClass}>
      <div className={formContainerClass}>
        <h1 className={titleClass}>ثبت محصول {selectGener[selectedCategoryIndex] || "Electronic"}</h1>
