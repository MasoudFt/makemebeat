...
const Rock = ({ Component }) => {
  ...
  const selectGener = ["هارد راک", "متال", "آلترناتیو", "پانک راک", "کلاسیک راک", "دیگر ..."];

  const [inputValues, setInputValues] = useState({
    user_id: tokenUserId,
    productName: "", productImage: null, createat: Time,
    type: ComponentType?.[0] || 'rock',
    gener: selectGener[0],
  ...
  const productCategoryGroups = [
    ...
    { name: "آلترناتیو", fields: [
        { name: "mp3 با تگ دارد.", field: "mainMP3File", labelInput: "mp3 با تگ .", type: "file", accept: ".mp3", note: "انواع فایل های مجاز : mp3, حداکثر اندازه فایل: 1000 MB." },
        { name: "wave دارد.", field: "waveFile", labelInput: "wave .", type: "file", accept: ".wav", note: "انواع فایل های مجاز : wav, حداکثر اندازه فایل: 100 MB." },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
    },
     { name: "پانک راک", fields: [
        { name: "mp3 با تگ دارد.", field: "mainMP3File", labelInput: "mp3 با تگ .", type: "file", accept: ".mp3", note: "انواع فایل های مجاز : mp3, حداکثر اندازه فایل: 1000 MB." },
        { name: "wave دارد.", field: "waveFile", labelInput: "wave .", type: "file", accept: ".wav", note: "انواع فایل های مجاز : wav, حداکثر اندازه فایل: 100 MB." },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
    },
     { name: "کلاسیک راک", fields: [
        { name: "mp3 با تگ دارد.", field: "mainMP3File", labelInput: "mp3 با تگ .", type: "file", accept: ".mp3", note: "انواع فایل های مجاز : mp3, حداکثر اندازه فایل: 1000 MB." },
        { name: "wave دارد.", field: "waveFile", labelInput: "wave .", type: "file", accept: ".wav", note: "انواع فایل های مجاز : wav, حداکثر اندازه فایل: 100 MB." },
        { name: "مبلغ اصلی", field: "primaryAmount", labelInput: "مبلغ اصلی", type: "text", note: "قیمت به تومان وارد شود." },
      ],
  ...
  const inputItems = [
    { label: "عنوان محصول", field: "productName", type: "text", placeholder: " راک" },
    ...
    { label: "گام موسیقی", field: "gammuisc", type: "text", placeholder: "مثال: E minor" },
    { label: "تمپو (BPM)", field: "tempo", type: "text", placeholder: "مثال: 160" },
  ];
  ...
  const resetForm = () => {
    setInputValues({
      ...
      type: ComponentType?.[0] || 'rock', gener: selectGener[selectedCategoryIndex] || selectGener[0],
      gammuisc: "", tempo: "", productDescription: "",
      demoMP3File: null, mainMP3File: null, tagMP3File: null, waveFile: null, projectFile: null, coverImage: null,
      primaryAmount: "", discountAmount: "", otherStyle: "",
    });
  ...
  return (
    <div dir="rtl" className={baseWrapperClass}>
      <div className={formContainerClass}>
        <h1 className={titleClass}>ثبت محصول {selectGener[selectedCategoryIndex] || "Rock"}</h1>
