...
const VideoList = () => {
    ...
    const image = [
      {
        name: "تدوین ادیت",
        url: "https://makemebeat.net/wp-content/uploads/2023/06/photo_2023-06-04_14-40-24.jpg",
      },
      {
        name: "کامینگ سون",
        url: "https://makemebeat.net/wp-content/uploads/2023/06/photo_2023-06-05_03-43-50.jpg",
      },
      {
        name: "تیزر",
        url: "https://makemebeat.net/wp-content/uploads/2023/06/photo_2023-06-04_14-28-48.jpg",
      },
      {
        name: "موزیک ویدیو",
      ...
      {
        name: "ریلز",
        url: "https://makemebeat.net/wp-content/uploads/2025/03/1-3.jpg",
      },
      {
        name: "موبایل گرافی",
        url: "https://makemebeat.net/wp-content/uploads/2023/06/photo_2023-06-04_14-31-40.jpg",
      }
    ];
              ...
              <div className={`mt-5 p-3 grid grid-cols-3 gap-2 `}>
                {image.slice(currentSlide, currentSlide + 3).map((a, i) => (
                  ...
                  >
                    <img
                      alt={a.name}
                      className="p-2 rounded-xl   shadow-sm h-72 w-full"
                      src={a.url}
                    />
