...
const input=useSelector(state=>state.showInput);
  ...
  return (
    <>
      ...
      <div className="flex ">
           <div
        className={` text-white rounded transition-all w-80 duration-300 ease-in-out transform ${
          input ? 'opacity-100 translate-y-0' : ' opacity-0 -translate-x-4'
        }`}
      >
      {/* <form class="w-80 max-w-lg mx-auto">
            <div class="flex">
              <label
                for="search-dropdown"
              ...
              <div class="relative w-full">
                <input
                  type="search"
                  id="search-dropdown"
                  class="block p-2.5 w-80 h-10 z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
...
<form className="max-w-md mx-auto">   
    ...
    <div className="relative">
        ...
        <button type="submit" className="text-white absolute end-1 bottom-0.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
    </div>
</form>
      </div>
      </div>
